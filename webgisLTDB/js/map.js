...
var serverURL = "https://s4.ad.brown.edu/s4gisserver/rest/services/LTDB/";
...
"esri/config", "dojo/i18n!esri/nls/jsapi",
    ...
    map.on("extent-change", function() {
	  ...
	  // esriConfig.defaults.io.corsEnabledServers.push("https://s4.ad.brown.edu/s4gisserver/rest/services/LTDB/");
...
/////////////////////////////////////////////////////////////////////////////
	...
	function openWin(){
	  //  $('#help').click(function () {
        var redirectWindow = window.open('https://www.s4.brown.edu', '_blank');
    ...
    dojo.query(".dropdown-toggle").on('click', function (e) {
        ...
        if(dojo.hasClass("dropdown", "open")){
        	...
        	dojo.query(".dropdown-menu").style("left", "-290px");
