...
var serverURL = "https://s4.ad.brown.edu/s4gisserver/rest/services/SouthAfrica/Joburgall";
...
require([
    ...
    map.centerAt(new Point(28.03, -26.19));
    ...
    var CPLayers = new ArcGISDynamicMapServiceLayer("https://s4.ad.brown.edu/s4gisserver/rest/services/SouthAfrica/Joburg/MapServer")
    ...
    //combo box setup
        ...
        onChange: function(layerName) {
            ...
            if (this.item!= null){
           cityURL = serverURL + '/MapServer';
            curVisible.push(this.item.layerID)
            updateLayerVisibility(cityURL, curVisible);
...
/////////////////////////////////////////////////////////////////////////////
 ...
 dojo.query(".dropdown-toggle").on('click', function (e) {
        ...
        if(dojo.hasClass("dropdown", "open")){
            ...
            dojo.query(".dropdown-menu").style("left", "-350px");
